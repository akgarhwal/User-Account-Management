...
class UserDAO:
    ...
    def validate_login(self, username, password):
        ...
        try:
            ...
            print "This VALIDATE LOGIN space intentionally left blank."
        except:
    ...
    def add_user(self, username, password, email,handle):
        password_hash = self.make_pw_hash(password)

        user = {'_id': username, 'password': password_hash,'handle' : handle}
        if email != "":
            user['email'] = email
